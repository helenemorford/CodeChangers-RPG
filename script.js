...
var storyList = [
    ...
    [["As things had been long before, the Humans and Mimiga had worked together in a constant struggle for the upper hand, in a strange but stable relationship.", 'desc'], 1, '', 2, 0, false, 1, 0],
    [["The Humans were consumers, with a destructive will but with the ability to wield what they consume. The Mimiga were producers, with the ability to wield what they created. Together, like the two sides of a coin, they lived in incongruity, but side by side they kept the world both alive and progressing forward, even if it was in a dissonant way.", 'desc'], 1, '', 3, 0, true, 1, 0],
    [["One day, something unthinkable had happened. A Mimiga scientist had discovered a way to change creatures in such a way as to make them conscious, to make them what we call today 'more human.' These creatures were labeled 'Monsters,' and were seen as enemies by Mimiga and Humans alike.", 'desc'], 1, '', 4, 0, false, 1, 0],
    ...
    [["Meanwhile, the rogue Mimiga scientist was dying in his lab, his old age finally taking a toll on him. As he lived through his last minutes, he releases his final creation on the world: The Red Flower. This creation was his final goodbye to the world; a curse upon his native people, those who threw him out, the Mimiga.", 'desc'], 1, '', 7, 0, false, 1, 0],
    ...
    [["Father: I bet you're really hungry! Today's a big day!", 'talk'], 2, '', 16, 0, true, 3, [0, 1, 0, 0]],
    ...
    [["You go the the kitchen, and inside you find a knife Mom has told you not to touch.", 'desc'], 2, ["TAKE THE KNIFE", "GO TO THE LIVING ROOM"], [22, 24], 0, true, 3, 0],
    [["You go to the closet and there is one of father's really thick jackets.", 'desc'], 2, ["TAKE THE JACKET", "GO TO THE LIVING ROOM"], [23, 24], 0, true, 3, 0],
    ...
    [["On the way to school, you pass by a food mill. There seems to be some sort of ruckus inside, and a few Mimiga Managers are going inside.", 'desc'], 5, ["GO INSIDE", "CONTINUE"], [27, 30], 0, true, 4, 0],
